...
def main():
    ...
    while start_screen == False:
        ...
        LeftText = myfont.render('Click any button to start the game',1, WHITE)
        MidText = font.render('Arrow keys are for moving',1,WHITE)
        RightText = font.render('Shoot bullets with space',1,WHITE)
